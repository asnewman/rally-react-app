import {comparePath, Failure, Success} from "./Router";
...
describe('comparePath tests', () => {
  ...
  it('works on valid match and slugs v2', () => {
    const res = comparePath("/rally/:id/:author/message/:messageid/day", "/rally/123/ash/message/999/day");
    ...
    expect(res).toBeInstanceOf(Success);
    expect(res.data).toEqual({doesMatch: true, slugs: { id: "123", author: "ash", messageid: "999" }})
  })
